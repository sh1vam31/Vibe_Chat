...
const ChatContainer = ({selectedUser,setSelectedUser}) => {
  ...
  return selectedUser? (
    <div className='h-full overflow-y-scroll relative backdrop-blur-lg ' > 
        ...
        <img src={assets.Batman_profile} alt="" className='w-8 rounded-full' /> 
         ...
         {messagesDummyData.map( (msg,index)=> (
            <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !=='680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
                ...
                <div className='text-center text-xs'>
                    <img src={msg.senderId === '680f50e4f10f3cd28382ecf9'? assets.avatar_icon : assets.Batman_profile} alt="" className='w-7 rounded-full'/>
         ...
         <div ref={scrollEnd} ></div>
              ...
              <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
                <div className='flex-1 flex items-center bg-blue-100/15 px-3 rounded-full'>
                  <input type="text" placeholder='send a message....' className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-white-400'/>
